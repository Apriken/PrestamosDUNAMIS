...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <!-- Aquí va el GridView dentro del formulario -->
            <hr />
            <h2 class="text-center mb-4">Pagos Realizados</h2>

            <asp:GridView ID="gvPagos" runat="server" CssClass="table table-bordered mt-4" AutoGenerateColumns="False" DataKeyNames="idPago_Prestamo" OnRowEditing="gvPagos_RowEditing" OnRowCancelingEdit="gvPagos_RowCancelingEdit" OnRowDeleting="gvPagos_RowDeleting">
                <Columns>
                    ...
                    <asp:BoundField DataField="Pago_Realizado" HeaderText="Pago Realizado" />
